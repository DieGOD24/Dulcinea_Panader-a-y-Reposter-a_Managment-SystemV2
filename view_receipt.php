...
<div class="container-fluid">
    <div id="outprint_receipt">
        <div class="text-center fw-bold lh-1">
            <span>Dulcinea | Panadería y Repostería Management System</span><br>
            <small>RECIBO</small>
        </div>
        ...
        <div class="fs-6 fs-light d-flex w-100 mb-1">
            <span class="col-auto pe-2">Recibo No:</span> 
        ...
        <table class="table table-striped">
            ...
            <tfoot>
                ...
                <tr>
                    <th class="px-1 py-0" colspan="2">Tax 19%</th>
                    <th class="px-1 py-0 text-end"><?php echo format_num($total * .19) ?></th>
                </tr>
                <tr>

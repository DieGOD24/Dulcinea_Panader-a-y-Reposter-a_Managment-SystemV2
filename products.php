...
<div class="card rounded-0 shadow">
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-tools align-middle">
            <button class="btn btn-dark btn-sm py-1 rounded-0" type="button" id="create_new">Añadir nuevo producto</button>
        </div>
    </div>
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Codigo</th>
                    <th class="text-center p-0">Categoria</th>
                    <th class="text-center p-0">Producto</th>
                    <th class="text-center p-0">Precio</th>
                    <th class="text-center p-0">Alerta</th>
                    <th class="text-center p-0">Status</th>
                    <th class="text-center p-0">Acciones</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <tr>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item view_data" data-id = '<?php echo $row['product_id'] ?>' href="javascript:void(0)">Ver detalles</a></li>
                            <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['product_id'] ?>' href="javascript:void(0)">Editar</a></li>
